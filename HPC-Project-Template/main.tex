...
\begin{itemize}
  ...
  and addition and assign one thread per each element of the output matrix. 
  ...
  \end{itemize}
  \subsection{Implementaions parameters}
  Each of our cuda implementaions, exept for the thread coarsening one uses threadblocks of 32 * 32.
